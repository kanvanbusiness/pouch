...
class OTPVerification extends Component {
    ...
    componentDidUpdate(prevProps){
        ...
        if (this.props.isCategoryDataGetSuccess !== prevProps.isCategoryDataGetSuccess) {
            this._callDashboard()
        ...
        console.log(" this.props.error isShowErrorAlertOTP:", this.props.isShowErrorAlertOTP)
...
<KeyboardAwareScrollView style={{flex:1}}>
                    ...
                    width: 40, height: 40, marginLeft:20, marginRight:20
                 
                     }} activeOpacity={0.5} onPress={() => this._onPressBack()}>

<Image source={IMAGES.BACKBTN} style={{ width:30, height:30, marginLeft: 0, marginTop: 0 }}></Image>
                        ...
                        <View style={{
                            ...
                            <View style={{
                               ...
                               backgroundColor: 'transparent', borderRadius: 60, shadowColor: '#000000',
...
const mapDispatchToProps = dispatch => ({
    ...
    userLoginAttemptSessionClearData: () => dispatch(userLoginAttemptSessionClearData()),
